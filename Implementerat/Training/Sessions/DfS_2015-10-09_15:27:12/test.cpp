...
void visit( vertex* v, int *t, int pred ){
	...
	*t = *t +1;
	v->colour = BLACK;
	// cout << "vv " << v->label<< v->colour << v->predecessor << v->discoveryT  << v->finishT << endl;
}
...
bool vertexequals( vertex *v1, vertex *v2 ){
	// cout << v1->label << v1->colour << v1->predecessor << v1->discoveryT  << v1->finishT << endl;
	// cout << v2->label << v2->colour << v2->predecessor << v2->discoveryT  << v2->finishT << endl;
